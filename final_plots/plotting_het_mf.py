...
mt_al = axarr[0].plot(n_finals, mt_vals['MT_al_MSE'], color = 'red', label='MF - Active')
mt_rn = axarr[0].plot(n_finals, mt_vals['MT_rn_MSE'], color = 'blue', label = 'MF - Random')
mt_uc = axarr[0].plot(n_finals, mt_vals['MT_uc_MSE'], color = 'green', label = 'MF - Uncertainty')
axarr[0].set_title('Heteroskedastic simulation', fontsize = 12)
