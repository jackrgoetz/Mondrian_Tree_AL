...
def cv_pwl_forest(data_seed=0,tree_seed=0):
    n_points = 40000
    n_test_points = 5000
    ...
    X, y = toy_data_pw_linear(n=n_points,p=p,high_area=high_area,high_constant=high_constant,
        low_constant=low_constant,std=std, set_seed=data_seed, marginal=marginal)
    ...
    X_test, y_test = toy_data_pw_linear(n=n_points,p=p,high_area=high_area,high_constant=high_constant,
        low_constant=low_constant,std=std, set_seed=data_seed+1, marginal=marginal)
