...
for n_final_ind, n_final in enumerate(n_finals):
    ...
    for data_seed in data_seeds:
        ...
        for tree_seed in tree_seeds:
            ...
            BT_al = Breiman_Tree(seed=tree_seed, min_samples_leaf=5)
            ...
            BT_rn = DecisionTreeRegressor(random_state=tree_seed, min_samples_leaf=5)
            ...
            # BT_uc
            BT_uc = Breiman_Tree(seed = tree_seed, min_samples_leaf=5)
            ...
            for _ in range(int((n_final - n_start)/batch_size)):
                ...
                new_points = BT_uc.pick_new_points()
                for new_point in new_points:
...
np.savez('graphs/sim_var_complexity_BT_' + str(p) + '_' + 
...
plt.tight_layout()
plt.savefig('graphs/sim_var_complexity_BT_' + str(p) + '_' + 
