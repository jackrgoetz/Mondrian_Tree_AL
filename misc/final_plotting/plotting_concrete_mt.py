...
mt_vals = dict(np.load('sim_concrete_uc_2500.npz'))
...
axarr[0].set_title('Concrete experiment. m = 1030, d = 8', fontsize = 12)
...
plt.savefig('final_plots/concrete_final_mt.pdf')