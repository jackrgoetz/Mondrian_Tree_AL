from paper_het_forest_flux_para import *
...
data_seeds = [x * 11 for x in range(25)]
tree_seeds = [x * 13 for x in range(25)]
...
results = Parallel(n_jobs=n_jobs,verbose=verbose)(delayed(cv_het_forest)(
...
np.savez('graphs/sim_het_forest_' + 
...
plt.tight_layout()
plt.savefig('graphs/sim_het_forest_' + 
