...
ccpp_data = np.genfromtxt('data_sets/airfoil_self_noise.csv', delimiter = ',')
...
for n_final_ind, n_final in enumerate(n_finals):
    ...
    if n_final_ind > 1:
        ...
        np.savez('graphs/sim_airfoil_uc_' + 
        ...
        axarr[0].set_title('Airfoil experiment')
        ...
        plt.tight_layout()
        plt.savefig('graphs/sim_airfoil_uc_' + 
