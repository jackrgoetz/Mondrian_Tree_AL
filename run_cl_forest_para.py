from paper_cl_forest_flux_para import *
...
data_seeds = [x * 11 for x in range(3)]
tree_seeds = [x * 13 for x in range(3)]
...
results = Parallel(n_jobs=n_jobs,verbose=verbose)(delayed(cv_cl_forest)(
